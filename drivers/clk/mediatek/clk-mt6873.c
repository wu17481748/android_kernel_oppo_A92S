...
#define INFRA_CG0	0x03AF8200	/* pwm:21~15,uart:23,24,25,gce2:9 */
...
static const struct mtk_gate infra_clks[] __initconst = {
	...
	GATE(INFRACFG_AO_AP_DMA_CG_UART, "infracfg_ao_ap_dma_cg_uart",
			"infracfg_ao_ap_dma_pseudo_cg",
			infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_BTIF, "infracfg_ao_ap_dma_cg_btif",
			"infracfg_ao_ap_dma_pseudo_cg",
			infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C0, "infracfg_ao_ap_dma_cg_i2c0",
			"infracfg_ao_ap_dma_pseudo_cg",
			infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C1, "infracfg_ao_ap_dma_cg_i2c1",
		"infracfg_ao_ap_dma_pseudo_cg",
		infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C2, "infracfg_ao_ap_dma_cg_i2c2",
		"infracfg_ao_ap_dma_pseudo_cg",
		infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C3, "infracfg_ao_ap_dma_cg_i2c3",
		"infracfg_ao_ap_dma_pseudo_cg",
		infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C4, "infracfg_ao_ap_dma_cg_i2c4",
		"infracfg_ao_ap_dma_pseudo_cg",
		infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C5, "infracfg_ao_ap_dma_cg_i2c5",
		"infracfg_ao_ap_dma_pseudo_cg",
		infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C6, "infracfg_ao_ap_dma_cg_i2c6",
		"infracfg_ao_ap_dma_pseudo_cg",
		infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C7, "infracfg_ao_ap_dma_cg_i2c7",
		"infracfg_ao_ap_dma_pseudo_cg",
		infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C8, "infracfg_ao_ap_dma_cg_i2c8",
		"infracfg_ao_ap_dma_pseudo_cg",
		infracfg_ao_module_sw_cg_5_regs, 31, 0),

	GATE(INFRACFG_AO_AP_DMA_CG_I2C9, "infracfg_ao_ap_dma_cg_i2c9",
		"infracfg_ao_ap_dma_pseudo_cg",
		infracfg_ao_module_sw_cg_5_regs, 31, 0),
};
