...
//#endif
    ...
    case OPPO_19420:
#ifdef CONFIG_MACH_MT6873
        pr_info("[TP] enter case OPPO_19420 export \n");
        if (tp_used_index == nt36672c) {
            snprintf(panel_data->fw_name, MAX_FW_NAME_LENGTH,
                     "tp/19131/FW_%s_%s_EXPORT.img",
                     "NF_NT36672C", vendor);
            ...
            panel_data->manufacture_info.fw_path = panel_data->fw_name;
            if ((tp_used_index == nt36672c) && (g_tp_dev_vendor == TP_JDI)) {
                pr_info("[TP]: firmware_headfile = export_FW_19420_NF_NT36672C_JDI_fae_jdi\n");
                memcpy(panel_data->manufacture_info.version, "0xDD300JN200", 12);
                panel_data->firmware_headfile.firmware_data = export_FW_19420_NF_NT36672C_JDI_fae_jdi;
                panel_data->firmware_headfile.firmware_size = sizeof(export_FW_19420_NF_NT36672C_JDI_fae_jdi);
            }
            if ((tp_used_index == nt36672c) && (g_tp_dev_vendor == TP_TIANMA)) {
                pr_info("[TP]: firmware_headfile = export_FW_19420_NF_NT36672C_TIANMA_fae_tianma\n");
                memcpy(panel_data->manufacture_info.version, "0xDD300TN000", 12);
                panel_data->firmware_headfile.firmware_data = export_FW_19420_NF_NT36672C_TIANMA_fae_tianma;
                panel_data->firmware_headfile.firmware_size = sizeof(export_FW_19420_NF_NT36672C_TIANMA_fae_tianma);
            }
        }
