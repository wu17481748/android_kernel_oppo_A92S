...
#ifdef CONFIG_TFA9874_NONDSP_STEREO
/*Zhao.Pan@PSW.MM.AudioDriver.SmartPA, 2020/01/08, Add for stereo spk*/
		if (!strcmp(mt6885_mt6359_dai_links[i].name, "I2S3") || !strcmp(mt6885_mt6359_dai_links[i].name, "I2S0")) {
			dev_info(&pdev->dev, "%s: codec_node no use for %s\n", __func__, mt6885_mt6359_dai_links[i].name);
			continue;
		}
#endif /* CONFIG_TFA9874_NONDSP_STEREO */
#endif /* VENDOR_EDIT */
