...
static int mt6359_set_aud_global_bias(struct mt6359_priv *priv, bool enable)
{
	...
	/* Jianqing.Liao@PSW.MM.AudioDriver.Machine, 2019/12/10, remove for dbmdx micbias */
			       ...
			       int event)
{
	...
	case SND_SOC_DAPM_POST_PMD:
#ifndef CONFIG_SND_SOC_DBMDX
		/* Jianqing.Liao@PSW.MM.AudioDriver.Machine, 2019/10/17, remove for dbmdx micbias */
...
/* Jianqing.Liao@PSW.MM.AudioDriver.Machine, 2019/12/10, add dbmdx */
